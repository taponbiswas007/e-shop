                ...
                <form @submit.prevent="submit">
                    <div class="px-4 py-5 sm:p-6 space-y-6">
                        ...
                        <div class="border-b border-gray-200 pb-6">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Upload product images</p>
                                ...
                                <div class="sm:col-span-6">
                                    ...
                                    <div class="mt-1 grid grid-cols-2 gap-4 sm:grid-cols-5">
                                        <div v-for="i in 5" :key="i" class="relative">
                                            ...
                                            <button v-if="form[`image_${i}_preview`]" type="button"
                        ...
                        <div class="border-b border-gray-200 pb-6">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Set product pricing information</p>
